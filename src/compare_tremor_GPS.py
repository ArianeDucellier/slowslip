...
#    plot_correlations()
    ...
    # Level 7-8: 1.0 - Level 6-7-8: 1.1 - Level 5-6-7-8: 1.1 - Level 5-6-7: 0.6 - Level 5-6: 0.5
    # For tremor data:
    # Level 10: 0.01 - Level 9: 0.01 - Level 8: 0.003 - Level 7: 0.009 - Level 6: 0.01 - Level 5: 0.01 - Level 4: 0.007
    # Level 7-8: 0.014 - Level 6-7-8: 0.01 - Level 5-6-7-8: 0.01 - Level 5-6-7: 0.01 - Level 5-6: 0.01

    thresh_GPS = np.arange(0.1, 1.6, 0.1)
    thresh_tremor = np.arange(0.001, 0.011, 0.001)
#    thresh_GPS = np.arange(0.5, 1.6, 0.1)
#    thresh_tremor = np.arange(0.005, 0.016, 0.001)
    chosen_GPS = 0.7
    chosen_tremor = 0.01
    J = [6, 7]
